...
#questa parte non funge
                ...
                if (!isset($_SESSION["login"])){
                  ...
                  echo "  <li class= ";
                    if ($activePage=="index.php" || $activePage=="") {echo " \"active \" "; } else  {echo " \"noactive\"";}
                    echo "><a href=\"login_form.php\">Login</a></li> ";

                  echo "  <li class= "; if ($activePage=="registration_form.php" || $activePage=="") {echo " \"active \" "; } else  {echo " \"noactive\"";} echo "><a href=\"registration_form.php\">SignUp</a></li> ";
